...
@Component({
  selector: 'app-pasthistorylist',
  templateUrl: './pasthistorylist.component.html',
  styleUrls: ['./pasthistorylist.component.css']
})
export class PasthistorylistComponent implements OnInit {
    book_item: any;
    pdf: any=[];
    pdfListView: any =[];
    listData: any;
    ...
    constructor(private route: ActivatedRoute, private se:PastHistoryService,
