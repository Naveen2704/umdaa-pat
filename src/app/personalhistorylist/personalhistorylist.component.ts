...
@Component({
  selector: 'app-personalhistorylist',
  templateUrl: './personalhistorylist.component.html',
  styleUrls: ['./personalhistorylist.component.css']
})
export class PersonalhistorylistComponent implements OnInit {
    book_item: any;
    pdf: any=[];
    pdfListView: any =[];
    listData: any;
    ...
    constructor(private route: ActivatedRoute, private se:PersonalHistoryService,
