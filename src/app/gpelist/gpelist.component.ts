...
@Component({
  selector: 'app-gpelist',
  templateUrl: './gpelist.component.html',
  styleUrls: ['./gpelist.component.css']
})
  export class GpelistComponent implements OnInit {
    book_item: any;
    pdf: any=[];
    pdfListView: any =[];
    listData: any;
  ...
  app_id: any;
    ...
    constructor(private route: ActivatedRoute, private se:GpeService,
