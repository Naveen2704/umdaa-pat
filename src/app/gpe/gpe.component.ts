...
@Component({
  ...
  disabled: boolean = false;
      ...
      constructor(private _service: PatientserviceService,private users: UsersService,private se:GpeService, private route: ActivatedRoute, public dialog: MatDialog, 
     ...
     //text boxes
      ...
      final(removeformId)
      {
        ...
        console.log(this.id);
         ...
         var getInfo1 = localStorage.getItem('GPE'+this.id+'1');
         var getInfo2 = localStorage.getItem('GPE'+this.id+'2');
        ...
        {
          var getInfo3 = localStorage.getItem('GPE'+this.id+this.impIds[j].id);
          if(getInfo3 != null)
          {
          ...
          this.se.saveData(this.id,removeformId,this.array123,this.main_section,this.getPreviewOne).subscribe((data)=>{
            ...
            if(data.code == 200)
            {
                this.se.getList(this.id).subscribe((data)=>{
                  ...
                  this.router.navigate(['/GpeList/'+this.id]);
                  localStorage.removeItem('GPE'+this.id+'1');
                  localStorage.removeItem('GPE'+this.id+'2');
                  for(var j=0;j<this.impIds.length;j++)
                  {
                    localStorage.removeItem('GPE'+this.id+this.impIds[j].id);
                  }
                });
            }
          });
      ...
      form_images(a,b)
      {
        ...
        this.router.navigate(['/preview/'+'GPE/'+this.id+'/'+b,a,,this.id1]);
      }

      
      openDialog(){
        this.router.navigate(['/secondsketch/'+'GPE/'+this.id+'/'+this.id1]);
