...
import { PastHistoryService } from '../history/past-history.service';
import { TreatmentHistoryService } from '../history/treatment-history.service';
...
@Component({
  selector: 'app-treatmenthistorylist',
  templateUrl: './treatmenthistorylist.component.html',
  styleUrls: ['./treatmenthistorylist.component.css']
})
export class TreatmenthistorylistComponent implements OnInit {
    book_item: any;
    pdf: any=[];
    pdfListView: any =[];
    listData: any;
    ...
    constructor(private route: ActivatedRoute, private se:TreatmentHistoryService,
