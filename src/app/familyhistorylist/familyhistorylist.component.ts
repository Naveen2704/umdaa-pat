...
import { FamilyHistoryService } from '../history/family-history.service';
...
@Component({
  selector: 'app-familyhistorylist',
  templateUrl: './familyhistorylist.component.html',
  styleUrls: ['./familyhistorylist.component.css']
})
export class FamilyhistorylistComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private se:FamilyHistoryService,
