...
@Component({
  ...
  disabled: boolean = false;
      ...
      constructor(private _service:PatientserviceService,private users: UsersService,private se:OsService, private route: ActivatedRoute, public dialog: MatDialog, 
        private router: Router,public _notification:NotificationService) { }
     ...
     //text boxes
      ...
      final(removeformId)
      {
        ...
        console.log(this.id);
         ...
         var getInfo1 = localStorage.getItem('OS'+this.id+'1');
         var getInfo2 = localStorage.getItem('OS'+this.id+'2');
        ...
        {
          var getInfo3 = localStorage.getItem('OS'+this.id+this.impIds[j].id);
          if(getInfo3 != null)
          {
          ...
          this.se.saveData(this.id,removeformId,this.array123,this.main_section,this.getPreviewOne).subscribe((data)=>{
            ...
            if(data.code == 200)
            {
                this.se.getList(this.id).subscribe((data)=>{
                  ...
                  this.router.navigate(['/OsList/'+this.id]);
                });
                localStorage.removeItem('OS'+this.id+'1');
                localStorage.removeItem('OS'+this.id+'2');
                for(var j=0;j<this.impIds.length;j++)
                {
                  localStorage.removeItem('OS'+this.id+this.impIds[j].id);
                }
            }
          });
         }
      ...
      form_images(a,b)
      {
        ...
        this.router.navigate(['/preview/'+'OS/'+this.id+'/'+b,a,,this.id1]);
      ...
      checkImage(a,b)
      {
        this.router.navigate(['/special/'+'OS/'+this.id+'/'+b+'/'+a]);
