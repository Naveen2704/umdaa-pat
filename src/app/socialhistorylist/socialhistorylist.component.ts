...
import { SocialHistoryService } from '../history/social-history.service';
...
@Component({
  selector: 'app-socialhistorylist',
  templateUrl: './socialhistorylist.component.html',
  styleUrls: ['./socialhistorylist.component.css']
})
export class SocialhistorylistComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private se:SocialHistoryService,
