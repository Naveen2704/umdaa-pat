...
import { HopiService } from '../hopi/hopi.service';
...
@Component({
  selector: 'app-hopilist',
  templateUrl: './hopilist.component.html',
  styleUrls: ['./hopilist.component.css']
})
export class HopilistComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private se:HopiService,
